...
namespace Sample {
    ...
    public:
        ...
        Rule(const std::string name, int priority, BGSFootstepSet* replacement, bool short_circuit,
             EvalMode eval_mode, const std::vector<std::shared_ptr<BasePredicate>> conditions)
            : name{name},
              priority{priority},
